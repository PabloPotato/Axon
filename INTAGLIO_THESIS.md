...
- **Year 1 (2026):** Intaglio Treasury — wedge.
- **Year 2–3:** Intaglio Policy (multi-agent RBAC), Intaglio Observe (anomaly detection), Intaglio Compliance (regulatory automation).
- **Year 4–6:** Intaglio Budget, Intaglio Identity, Intaglio Audit, Intaglio Benchmark, Intaglio Insurance.
...
*For the pitch — `INTAGLIO_SUPERTEAM_PITCH.md`. For the build — `INTAGLIO_60_DAY_BUILD_PLAN.md`. For the numbers — `INTAGLIO_STRATEGIC_SYNTHESIS.md`. For the hidden insight — `INTAGLIO_ORACLE_NOTE.md`.*
