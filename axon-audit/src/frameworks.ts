// axon-audit — frameworks.ts
// Maps Axon audit-record fields to specific articles of the three EU frameworks
// an Axon customer is trying to satisfy:
//
...
export const FRAMEWORKS: FrameworkRequirement[] = [
  ...
  },
  {
    ...
    axon_evidence:
      "Axon chain-exports are replayable end-to-end: given the policy source and the record stream, any third party can re-evaluate the decision and confirm it matches the recorded outcome.",
  ...
  },
  {
    ...
    axon_evidence:
      "The Axon audit export is structured so that the operator can filter records by (decision.outcome ≠ APPROVE) and hand the resulting subset, with independently-verifiable hashes, to the competent authority.",
