...
export interface IntaglioEngineOptions {
  chain?: AuditChain;
  obligationEmitters?: Array<(record: import("./types.js").AuditRecord) => Promise<void> | void>;
}

export class IntaglioEngine {
  private readonly policy: Policy;
  private readonly chain: AuditChain;
  private readonly emitters: NonNullable<IntaglioEngineOptions["obligationEmitters"]>;

  constructor(policySource: string | Policy, opts: IntaglioEngineOptions = {}) {
