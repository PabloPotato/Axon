...
- **Ask:** 30-min design-partner call. Free tier of Axon for 90 days in exchange for feedback + logo.
...
- **Ask:** Partnership exploration (Axon below, Emergence workflows above).

### 5. Natural (YC, $9.8M, Ramp founders' bet)
- **Why:** Overlapping TAM. Better to partner than compete. Their customer base (freight, healthcare, procurement) is where Axon wants to land.
...
- **Why:** 40K enterprise developer base. Possible distribution channel for Axon's governance layer above their wallet infra.
...
- **Ask:** Explore integration — Axon as the "policy layer" sold to Crossmint customers.
...
- **Ask:** Platform partnership — Axon as default governance tier.
...
- **Ask:** Feasibility of a Devin-Axon pilot.
...
- **Angle:** Not pitching for customer, pitching "eventual acquisition target." Axon is the EU / crypto-native extension Ramp doesn't want to build itself.
...
- **Talking points:** Axon is the enterprise enforcement layer above x402 — you ship the protocol, we ship the product ops buy.
